...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/crud$1.0.0/templates/html/fornecedores.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html lang=en><head><meta charset=UTF-8><meta http-equiv=X-UA-Compatible content=IE=edge><meta name=viewport content=\"width=device-width, initial-scale=1.0\"><title>Seja nosso Fornecedor</title> <link rel=stylesheet href=https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css><link href=https://fonts.googleapis.com/icon?family=Material+Icons rel=stylesheet><link rel=stylesheet href=../css/fornecedores.css></head><body><div class=container><header><a href=/ >Volte à página inicial</a></header><h1>Estoques</h1><a href=/remersas class=\"btn-floating btn-large waves-effect  waves-light white\"><i class=material-icons style=color:#EB5757;>add</i></a> <table><thead><th>id</th><th>Tipo do Café</th> <th>Quantidade em estoque</th></thead>");

  var $for$0 = 0;

  marko_forOf(data.results, function(cafe, index) {
    var $keyScope$0 = "[" + (($for$0++) + "]");

    out.w("<tr><td>" +
      marko_escapeXml(cafe.id) +
      "</td><td>" +
      marko_escapeXml(cafe.cafe) +
      "</td><td>" +
      marko_escapeXml(cafe.quantidade) +
      "</td><td><a style=\"margin-right: 10px;\"" +
      marko_attr("href", "/remersas/" + (cafe.id == null ? "" : cafe.id)) +
      " class=\"btn-floating btn-medium waves-effect waves-light linen white\"><i class=material-icons style=color:#EB5757;>edit</i></a><a" +
      marko_attr("href", "/fornecedores/delete/" + (cafe.id == null ? "" : cafe.id)) +
...
marko_template.meta = {
    id: "/crud$1.0.0/templates/html/fornecedores.marko",
    tags: [
